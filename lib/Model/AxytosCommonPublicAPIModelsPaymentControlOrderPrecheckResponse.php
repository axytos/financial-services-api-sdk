...
class AxytosCommonPublicAPIModelsPaymentControlOrderPrecheckResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'approved_payment_type_securities' => '\Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIEnumsPaymentTypeSecurity[]',
        'process_id' => 'string',
        'decision' => 'string',
        'transaction_metadata' => '\Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPITransactionTransactionMetadata',
        'step' => 'string',
        'risk_taker' => '\Axytos\FinancialServicesAPI\Client\Model\AxytosCommonEnumsRiskTaker'
    ];
    ...
    protected static $openAPIFormats = [
        'approved_payment_type_securities' => null,
        'process_id' => null,
        'decision' => null,
    ...
    protected static $attributeMap = [
        'approved_payment_type_securities' => 'approvedPaymentTypeSecurities',
    ...
    protected static $setters = [
        'approved_payment_type_securities' => 'setApprovedPaymentTypeSecurities',
        'process_id' => 'setProcessId',
        'decision' => 'setDecision',
        'transaction_metadata' => 'setTransactionMetadata',
        'step' => 'setStep',
        'risk_taker' => 'setRiskTaker'
    ];
    ...
    protected static $getters = [
        'approved_payment_type_securities' => 'getApprovedPaymentTypeSecurities',
        'process_id' => 'getProcessId',
        'decision' => 'getDecision',
        'transaction_metadata' => 'getTransactionMetadata',
        'step' => 'getStep',
        'risk_taker' => 'getRiskTaker'
    ];
     ...
     *
     * @param \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIEnumsPaymentTypeSecurity[] $approved_payment_type_securities approved_payment_type_securities
     *
     * @return self
     */
     ...
     *
     * @return \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPITransactionTransactionMetadata
     */
     ...
     *
     * @param \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPITransactionTransactionMetadata $transaction_metadata transaction_metadata
     *
     * @return self
     */
     ...
     * Gets risk_taker
     *
     * @return \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonEnumsRiskTaker|null
     */
     ...
     * Sets risk_taker
     *
     * @param \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonEnumsRiskTaker|null $risk_taker risk_taker
     *
     * @return self
     */
