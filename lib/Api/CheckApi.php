...
class CheckApi
{
     ...
     *
     * @param  \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlRequest $axytos_common_public_api_models_payment_control_payment_control_request axytos_common_public_api_models_payment_control_payment_control_request (optional)
     *
     * @throws \Axytos\FinancialServicesAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlResponse|\Axytos\FinancialServicesAPI\Client\Model\MicrosoftAspNetCoreMvcProblemDetails|\Axytos\FinancialServicesAPI\Client\Model\MicrosoftAspNetCoreMvcProblemDetails|\Axytos\FinancialServicesAPI\Client\Model\MicrosoftAspNetCoreMvcProblemDetails
     */
     ...
     * checks which payment types can be offered safely
     *
     * @param  \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlRequest $axytos_common_public_api_models_payment_control_payment_control_request (optional)
     *
     * @throws \Axytos\FinancialServicesAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function apiV1CheckRiskPaymentcontrolCheckPostWithHttpInfo($axytos_common_public_api_models_payment_control_payment_control_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlResponse', []),
            ...
            $returnType = '\Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlResponse',
    ...
    {
        return $this->apiV1CheckRiskPaymentcontrolCheckPostAsyncWithHttpInfo($axytos_common_public_api_models_payment_control_payment_control_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function apiV1CheckRiskPaymentcontrolCheckPostRequest($axytos_common_public_api_models_payment_control_payment_control_request = null)
    {
        ...
        if (isset($axytos_common_public_api_models_payment_control_payment_control_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($axytos_common_public_api_models_payment_control_payment_control_request));
            } else {
     ...
     *
     * @param  \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlConfirmRequest $axytos_common_public_api_models_payment_control_payment_control_confirm_request axytos_common_public_api_models_payment_control_payment_control_confirm_request (optional)
     *
     * @throws \Axytos\FinancialServicesAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * confirms payment without order creation
     *
     * @param  \Axytos\FinancialServicesAPI\Client\Model\AxytosCommonPublicAPIModelsPaymentControlPaymentControlConfirmRequest $axytos_common_public_api_models_payment_control_payment_control_confirm_request (optional)
     *
     * @throws \Axytos\FinancialServicesAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        return $this->apiV1CheckRiskPaymentcontrolConfirmPostAsyncWithHttpInfo($axytos_common_public_api_models_payment_control_payment_control_confirm_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function apiV1CheckRiskPaymentcontrolConfirmPostRequest($axytos_common_public_api_models_payment_control_payment_control_confirm_request = null)
    {
        ...
        if (isset($axytos_common_public_api_models_payment_control_payment_control_confirm_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($axytos_common_public_api_models_payment_control_payment_control_confirm_request));
            } else {
