...
class CustomerDataApi
{
    ...
    {
        return $this->apiV1CustomerDataUploadCustomerDataPostAsyncWithHttpInfo($file)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function apiV1CustomerDataUploadCustomerDataPostRequest($file)
    {
        ...
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling apiV1CustomerDataUploadCustomerDataPost'
            );
        }
