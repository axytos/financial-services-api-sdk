...
/**
 * AxytosCommonPublicAPIEnumsPaymentControlRequestMode Class Doc Comment
 *
 * @category Class
 * @package Axytos\FinancialServices\OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AxytosCommonPublicAPIEnumsPaymentControlRequestMode
{
    /**
    ...
    {
        return [self::SINGLE_STEP, self::TWO_STEPS];
    }
}
