...
/**
 * AxytosCommonPublicAPIModelsOrderBasketPosition
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AxytosCommonPublicAPIModelsOrderBasketPosition Class Doc Comment
 *
 * @category Class
 * @package Axytos\FinancialServices\OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AxytosCommonPublicAPIModelsOrderBasketPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Axytos.Common.PublicAPI.Models.Order.BasketPosition';
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $openAPITypes = ['product_id' => 'string', 'product_name' => 'string', 'product_category' => 'string', 'quantity' => 'int', 'tax_percent' => 'double', 'net_price_per_unit' => 'double', 'gross_price_per_unit' => 'double', 'net_position_total' => 'double', 'gross_position_total' => 'double'];
    /**
     ...
     */
    protected static $openAPIFormats = ['product_id' => null, 'product_name' => null, 'product_category' => null, 'quantity' => 'int32', 'tax_percent' => 'double', 'net_price_per_unit' => 'double', 'gross_price_per_unit' => 'double', 'net_position_total' => 'double', 'gross_position_total' => 'double'];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['product_id' => 'productId', 'product_name' => 'productName', 'product_category' => 'productCategory', 'quantity' => 'quantity', 'tax_percent' => 'taxPercent', 'net_price_per_unit' => 'netPricePerUnit', 'gross_price_per_unit' => 'grossPricePerUnit', 'net_position_total' => 'netPositionTotal', 'gross_position_total' => 'grossPositionTotal'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['product_id' => 'setProductId', 'product_name' => 'setProductName', 'product_category' => 'setProductCategory', 'quantity' => 'setQuantity', 'tax_percent' => 'setTaxPercent', 'net_price_per_unit' => 'setNetPricePerUnit', 'gross_price_per_unit' => 'setGrossPricePerUnit', 'net_position_total' => 'setNetPositionTotal', 'gross_position_total' => 'setGrossPositionTotal'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['product_id' => 'getProductId', 'product_name' => 'getProductName', 'product_category' => 'getProductCategory', 'quantity' => 'getQuantity', 'tax_percent' => 'getTaxPercent', 'net_price_per_unit' => 'getNetPricePerUnit', 'gross_price_per_unit' => 'getGrossPricePerUnit', 'net_position_total' => 'getNetPositionTotal', 'gross_position_total' => 'getGrossPositionTotal'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['net_price_per_unit'] === null) {
            $invalidProperties[] = "'net_price_per_unit' can't be null";
        }
        if ($this->container['gross_price_per_unit'] === null) {
            $invalidProperties[] = "'gross_price_per_unit' can't be null";
        }
        if ($this->container['net_position_total'] === null) {
            $invalidProperties[] = "'net_position_total' can't be null";
        }
        if ($this->container['gross_position_total'] === null) {
            $invalidProperties[] = "'gross_position_total' can't be null";
        }
     ...
     *
     * @param double $net_price_per_unit net_price_per_unit
     *
     * @return self
     */
     ...
     *
     * @param double $gross_price_per_unit gross_price_per_unit
     *
     * @return self
     */
     ...
     *
     * @param double $net_position_total net_position_total
     *
     * @return self
     */
     ...
     *
     * @param double $gross_position_total gross_position_total
     *
     * @return self
     */
