...
/**
 * AxytosCommonPublicAPIModelsOrderBasket
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AxytosCommonPublicAPIModelsOrderBasket Class Doc Comment
 *
 * @category Class
 * @package Axytos\FinancialServices\OpenAPI\Client
 * @author   OpenAPI Generator team
...
class AxytosCommonPublicAPIModelsOrderBasket implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Axytos.Common.PublicAPI.Models.Order.Basket';
    /**
    ...
    {
        if ($net_total < 0.001) {
            throw new \InvalidArgumentException('invalid value for $net_total when calling AxytosCommonPublicAPIModelsOrderBasket., must be bigger than or equal to 0.001.');
        }
    ...
    {
        if ($gross_total < 0.01) {
            throw new \InvalidArgumentException('invalid value for $gross_total when calling AxytosCommonPublicAPIModelsOrderBasket., must be bigger than or equal to 0.01.');
        }
     ...
     * Gets positions
     *
     * @return \Axytos\FinancialServices\OpenAPI\Client\Model\AxytosCommonPublicAPIModelsOrderBasketPosition[]
     */
     ...
     * Sets positions
     *
     * @param \Axytos\FinancialServices\OpenAPI\Client\Model\AxytosCommonPublicAPIModelsOrderBasketPosition[] $positions positions
     *
     * @return self
     */
