...
/**
 * AxytosApiModelsPaymentStateResponseModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AxytosApiModelsPaymentStateResponseModel Class Doc Comment
 *
 * @category Class
 * @package Axytos\FinancialServices\OpenAPI\Client
 * @author   OpenAPI Generator team
...
class AxytosApiModelsPaymentStateResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Axytos.Api.Models.PaymentStateResponseModel';
    /**
     ...
     */
    protected static $openAPIFormats = ['payment_state' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['payment_state' => 'paymentState'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['payment_state' => 'setPaymentState'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['payment_state' => 'getPaymentState'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
     ...
     * Gets payment_state
     *
     * @return \Axytos\FinancialServices\OpenAPI\Client\Model\AxytosApiEnumsOrderPaymentState|null
     */
     ...
     * Sets payment_state
     *
     * @param \Axytos\FinancialServices\OpenAPI\Client\Model\AxytosApiEnumsOrderPaymentState|null $payment_state payment_state
     *
     * @return self
     */
