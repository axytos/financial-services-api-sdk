...
/**
 * AxytosApiModelsUpdateOrderModel
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AxytosApiModelsUpdateOrderModel Class Doc Comment
 *
 * @category Class
 * @package Axytos\FinancialServices\OpenAPI\Client
 * @author   OpenAPI Generator team
...
class AxytosApiModelsUpdateOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Axytos.Api.Models.UpdateOrderModel';
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $openAPITypes = ['external_order_id' => 'string', 'basket' => 'Axytos\FinancialServices\OpenAPI\Client\Model\AxytosCommonPublicAPIModelsOrderBasket'];
    /**
     ...
     */
    protected static $openAPIFormats = ['external_order_id' => null, 'basket' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['external_order_id' => 'externalOrderId', 'basket' => 'basket'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['external_order_id' => 'setExternalOrderId', 'basket' => 'setBasket'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['external_order_id' => 'getExternalOrderId', 'basket' => 'getBasket'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
