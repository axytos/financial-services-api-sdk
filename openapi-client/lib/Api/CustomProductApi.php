...
class CustomProductApi
{
     ...
     *
     * @param  \Axytos\FinancialServices\OpenAPI\Client\Model\AxytosApiModelsCustomProductUsageModel $axytos_api_models_custom_product_usage_model axytos_api_models_custom_product_usage_model (optional)
     *
     ...
     * Tracks the usage of a custom (creditor-managed) product for a given debitor
     *
     * @param  \Axytos\FinancialServices\OpenAPI\Client\Model\AxytosApiModelsCustomProductUsageModel $axytos_api_models_custom_product_usage_model (optional)
     *
     * @throws \Axytos\FinancialServices\OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        return $this->apiV1CustomProductReportusagePostAsyncWithHttpInfo($axytos_api_models_custom_product_usage_model)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function apiV1CustomProductReportusagePostRequest($axytos_api_models_custom_product_usage_model = null)
    {
        ...
        if (isset($axytos_api_models_custom_product_usage_model)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \Axytos\FinancialServices\GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($axytos_api_models_custom_product_usage_model));
            } else {
