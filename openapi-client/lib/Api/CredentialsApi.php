...
class CredentialsApi
{
    ...
    /**
     * Operation apiV1CredentialsValidateGet
     *
     ...
     * @return void
     */
    public function apiV1CredentialsValidateGet()
    {
        $this->apiV1CredentialsValidateGetWithHttpInfo();
    }
    /**
     * Operation apiV1CredentialsValidateGetWithHttpInfo
     *
     * validate credentials
     *
     *
     ...
     */
    public function apiV1CredentialsValidateGetWithHttpInfo()
    {
        $request = $this->apiV1CredentialsValidateGetRequest();
        try {
    ...
    /**
     * Operation apiV1CredentialsValidateGetAsync
     *
     * validate credentials
     *
     *
     ...
     */
    public function apiV1CredentialsValidateGetAsync()
    {
        return $this->apiV1CredentialsValidateGetAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
     * Operation apiV1CredentialsValidateGetAsyncWithHttpInfo
     *
     * validate credentials
     *
     *
     ...
     * @return \Axytos\FinancialServices\GuzzleHttp\Promise\PromiseInterface
     */
    public function apiV1CredentialsValidateGetAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->apiV1CredentialsValidateGetRequest();
    ...
    /**
     * Create request for operation 'apiV1CredentialsValidateGet'
     *
     *
     * @throws \InvalidArgumentException
     * @return \Axytos\FinancialServices\GuzzleHttp\Psr7\Request
     */
    public function apiV1CredentialsValidateGetRequest()
    {
        $resourcePath = '/api/v1/Credentials/validate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
