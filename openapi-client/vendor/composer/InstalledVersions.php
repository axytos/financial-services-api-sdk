 ...
 */
namespace Axytos\FinancialServices\Composer;

use Axytos\FinancialServices\Composer\Autoload\ClassLoader;
use Axytos\FinancialServices\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    public static function getInstalledPackages()
    {
        ...
        return \array_keys(\array_flip(\call_user_func_array('Axytos\\FinancialServices\\array_merge', $packages)));
    }
    /**
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Axytos\\FinancialServices\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
