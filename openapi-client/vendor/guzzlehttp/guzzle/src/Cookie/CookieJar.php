...
namespace Axytos\FinancialServices\GuzzleHttp\Cookie;
...
class CookieJar implements CookieJarInterface
{
    ...
    {
        return \array_map(static function (SetCookie $cookie) {
    ...
    {
        $this->cookies = \array_filter($this->cookies, static function (SetCookie $cookie) {
            return !$cookie->getDiscard() && $cookie->getExpires();
        });
    }
    /**
     * @inheritDoc
     * @param \Axytos\FinancialServices\GuzzleHttp\Cookie\SetCookie $cookie
     * @return bool
     */
     ...
     * @param \Axytos\FinancialServices\Psr\Http\Message\ResponseInterface $response
     * @return void
     */
