...
use Axytos\FinancialServices\GuzzleHttp\Cookie\CookieJarInterface;
...
final class Middleware
{
        ...
        return static function (callable $handler) {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('Axytos\\FinancialServices\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
     ...
     * formatter.
     *
     * @phpstan-param \Axytos\FinancialServices\Psr\Log\LogLevel::* $logLevel  Level at which to log requests.
     *
     ...
     * @return callable Returns a function that accepts the next handler.
     */
    public static function log(LoggerInterface $logger, $formatter, $logLevel = 'info')
    {
